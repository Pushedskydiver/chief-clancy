...
- **Observed** (subset of PR #396 matching this scenario — PR #396 also co-mingled a §1 sibling-sweep adding 5 architectural-doc files):
...
- **Derived**:
  ...
  - `docs/REVIEW-PATTERNS.md` (if the rule emerged from an observed pattern)
