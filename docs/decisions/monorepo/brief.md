...
### Phase 0: Finish v0.8.24 *(current repo)*
...
### Phase 5: Core — board *(one PR per board)*
...
### Phase 6: Core — shared utilities *(grouped by dependency)*
...
### Phase 7: Core — lifecycle *(one PR per module)*
...
| 13.4 | Doc updates: SELF-REVIEW.md, LIFECYCLE.md, COMPARISON.md, roles/*.md, guides/*.md | All docs reviewed, paths and commands accurate |
