...
- Kanban board integration (Jira, GitHub Issues, Linear, Shortcut, Notion, Azure DevOps)
- Structured docs layer (`.clancy/docs/`) read before every run
- Epic branch git workflow with PR-based delivery
- Per-ticket progress logging and cost tracking
- Verification gates with self-healing retry
- Strategy briefs and planning workflows
- Crash recovery and AFK automation
...
See [github.com/Pushedskydiver/chief-clancy/graphs/contributors](https://github.com/Pushedskydiver/chief-clancy/graphs/contributors).
