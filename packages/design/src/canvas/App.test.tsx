...
describe('App', () => {
  ...
  it('positions the comment modal at the picked element bounding box (top + height, left)', () => {
    const variants: readonly Variant[] = [
      {
        id: 'v1',
        seed: 'editorial/magazine',
    ...
    const modal = screen.getByRole('dialog', { name: /comment/i });
  ...
  it('renders a textarea inside the comment modal for typing the comment', () => {
    const variants: readonly Variant[] = [
      {
        id: 'v1',
        seed: 'editorial/magazine',
    ...
    const modal = screen.getByRole('dialog', { name: /comment/i });
    const textbox = within(modal).getByRole('textbox', { name: /comment/i });
