 ...
 * lifecycle. Appending into a session that does not exist is a broken
 * invariant, so ENOENT on the directory propagates rather than being papered
 * over by a recursive mkdir.
 *
