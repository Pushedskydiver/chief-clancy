...
Each agent is defined in `.claude/clancy/agents/`. Pass the agent the full path to the docs directory and the project root.

| Agent    | Prompt file                               | Docs written                                                      |
| -------- | ----------------------------------------- | ----------------------------------------------------------------- |
| tech     | `.claude/clancy/agents/tech-agent.md`     | `STACK.md`, `INTEGRATIONS.md`                                     |
| arch     | `.claude/clancy/agents/arch-agent.md`     | `ARCHITECTURE.md`                                                 |
| quality  | `.claude/clancy/agents/quality-agent.md`  | `CONVENTIONS.md`, `TESTING.md`, `GIT.md`, `DEFINITION-OF-DONE.md` |
| design   | `.claude/clancy/agents/design-agent.md`   | `DESIGN-SYSTEM.md`, `ACCESSIBILITY.md`                            |
| concerns | `.claude/clancy/agents/concerns-agent.md` | `CONCERNS.md`                                                     |
