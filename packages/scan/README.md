...
Shared package containing the 5 specialist scanning agents and the `map-codebase` / `update-docs` commands and workflows. Consumed by [`@chief-clancy/brief`](https://www.npmjs.com/package/@chief-clancy/brief), [`@chief-clancy/plan`](https://www.npmjs.com/package/@chief-clancy/plan), [`@chief-clancy/dev`](https://www.npmjs.com/package/@chief-clancy/dev), and [`chief-clancy`](https://www.npmjs.com/package/chief-clancy) (the four packages that declare scan as a workspace dep and bundle its assets at install).
