...
describe('createBoard', () => {
  ...
  it('creates a Linear board', () => {
    const config: BoardConfig = {
      provider: 'linear',
      env: { LINEAR_API_KEY: 'lin_test', LINEAR_TEAM_ID: 'team-123' },
    };
  ...
  it('creates a Shortcut board', () => {
    const config: BoardConfig = {
      provider: 'shortcut',
      env: { SHORTCUT_API_TOKEN: 'sc_test' },
    };
  ...
  it('creates a Notion board', () => {
    const config: BoardConfig = {
      provider: 'notion',
      env: { NOTION_TOKEN: 'ntn_test', NOTION_DATABASE_ID: 'db-uuid' },
    };
  ...
  it('creates an Azure DevOps board', () => {
    const config: BoardConfig = {
      provider: 'azdo',
      env: { AZDO_ORG: 'myorg', AZDO_PROJECT: 'proj', AZDO_PAT: 'pat' },
    };
