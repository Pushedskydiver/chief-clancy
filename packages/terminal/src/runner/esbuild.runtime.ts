/**
 * esbuild config for bundling runtime scripts to ESM.
 *
 * Produces self-contained ESM bundles for the implement and autopilot
 * runners. These bundles are copied to the user's `.clancy/` directory
 * by the installer and executed via `node .clancy/clancy-implement.js`.
 *
