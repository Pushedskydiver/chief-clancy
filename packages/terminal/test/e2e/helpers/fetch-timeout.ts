 ...
 *
 * Any caller-provided `signal` in `init` is replaced by the timeout
 * signal — E2E helpers always use the timeout for hang protection.
 *
 * @param url - The URL to fetch.
 * @param init - Standard fetch RequestInit options.
 * @param timeoutMs - Timeout in milliseconds (default 15s).
 * @param fetcher - Fetch implementation (default global `fetch`).
