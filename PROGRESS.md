...
**Session 82 (PR0 — `docs/PROMOTION-PLAN.md` pointer + checklist):** Second PR in promotion plan v7. Added ephemeral `docs/PROMOTION-PLAN.md` — pointer-only per Decision 5 anti-duplication (does NOT copy plan content from `notes.md`). Includes merge-status table (PR-1 ✅ #295 landed; PR0 → PR6 tracked), per-PR housekeeping checklist, concurrent-modification embargo, and grilling cadence reminder. Deleted once PR6 lands.
