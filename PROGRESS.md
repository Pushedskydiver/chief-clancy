...
**Next (Session 81):** **Phase 3 of readability handoff** — eight decisions need Alex's input before promotion to repo docs. Listed in detail in `.claude/research/readability/notes.md`'s Phase 3 section. Headline decisions: (1) `core/` wildcard exports — tighten or accept TSDoc-everywhere, (2) rename "grilling" to "spec premortem" to avoid `GLOSSARY.md:71` collision, (3) P-rule owner/cadence model, (4) P1 ↔ P5 interaction, (5) PROGRESS/focus.md/memory precedence, (6) Rule 12 `error: string` vs typed unions, (7) Rule 7 reversal of barrel-maintenance practice, (8) review-gate assignments + new doc-section requirements. Then Phase 4 (review-gate fixes) and optional Phase 5 (re-grill). Fresh session recommended; notes are in defensible state — nothing fabricated, all collisions flagged, all known issues tracked.
