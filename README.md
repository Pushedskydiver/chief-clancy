...
| `/clancy:implement --from <dir> --afk` | Local batch — the workflow spec describes iterating approved plans as the local equivalent of autopilot. Runtime wiring for directory iteration is deferred; today the flag is a convention handled manually or via Claude Code |
